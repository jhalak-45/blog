    ...
    <div class="d-flex ">
        ...
        <div class="tab px-2 py-2" style="width: 82%; height:100%">
            <div class="container py-4 justify-content-between d-flex w-100 hover-none">
                <div class="h2 align-top">Settings</div>


            </div>
            <div class="container border-1 h-auto rounded-2 lg-px-3 py-3 bg-white shadow-lg">
                ...
                <div class="container bg-white px-2">
                    <form action="{{ route('setting.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row py-3 border-1 mb-2">
                            <div class="mb-3 form-group col-md-6">
                                <label for="name" class="form-label">Name:</label>
                                <input type="text" id="name" name="name" class="form-control border-gray-300"
                                    value="{{ $setting->name }}">
                            </div>
                            <div class="mb-3 form-group col-md-6">
                                <label for="img" class="form-label">About page Image:</label>
                                <div class="d-flex">
                        ...
                        <div class="row py-3 border-1 mb-2">
                            ...
                            <div class="mb-3 form-group  col-md-6">
                                <label for="img" class="form-label">Home Page Image:</label>
                                <div class="d-flex">
                        ...
                        <div class="mb-3 form-group">
                            <label for="des" class="form-label">About Page Introduction:</label>
                            <textarea id="des" rows="15" name="about"
